const UnderConstruction = () => {
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">I&apos;m currently building a new portfolio site. Check back soon to see the updates! ‍💻</p>
    </div>
</section>
  )
}
