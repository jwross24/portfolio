            ...
            <div className="flex w-full items-center justify-between">
              ...
              <div className="flex w-1/2 flex-col items-center self-center">
                ...
                <p className="my-4 text-base font-medium">
                  As a seasoned software developer, I bring a wealth of
                  experience in building seamless user experiences. Dive into my
                  latest projects, where I combine my technical skills with an
                  eye for design to deliver elegant and intuitive applications.
                </p>
